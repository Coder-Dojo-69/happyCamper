globe_debunk_dictionary = {
    ...
    'debunk_051': {
        'string_list' : [
            "power of the sun", "how does the sun work", "plasma of light", "what is the sun",
        ],
        ...
        'search_words' : ["magnify the power", "magnify the sun", "generate", "light waves", "burning rock", "mirror"]
    },
    'debunk_052': {
        'string_list' : [
