...
commands_dict = {
    ...
    '/help' : f"""Whenever you get stuck type in /start to get back on track.\n\nTo Report HappyCamper for not being happy contact https://t.me/dojosdailychat\n\n/start""",
    '/submit' : f"""Got your own debunk or auto-response sugestions please submit to https://t.me/dojosdailychat with @admin\n\n/start""",
